...
require_once('automatecrm-php-sdk/lib/curl_http_client.php');
require_once('automatecrm-php-sdk/lib/Zend/Json.php');

class ACRM_HTTP_Client extends Curl_HTTP_Client {
	var $_serviceurl = '';
